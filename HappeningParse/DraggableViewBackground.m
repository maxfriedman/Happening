...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        //NSLog(@"From DVB: slider value = %d", appDelegate.sliderValue);
        [eventQuery whereKey:@"GeoLoc" nearGeoPoint:userLoc withinMiles:(double)appDelegate.sliderValue];
...
-(DraggableView *)createDraggableViewWithDataAtIndex:(NSInteger)index
{
    ...
    [query findObjectsInBackgroundWithBlock:^(NSArray *objects, NSError *error) {
        ...
        /*
        @"#Nightlife",@"#Sports",@"#Music", @"#Shopping", @"#Freebies", @"#HappyHour", @"#Dining", @"#Entertainment", @"#Fundraiser", @"#Other"
...
-(void)loadCards
{
    ...
    PFGeoPoint *userLoc = [PFGeoPoint geoPointWithLocation:(locManager.location)];
    [query whereKey:@"GeoLoc" nearGeoPoint:userLoc withinMiles:(double)appDelegate.sliderValue];
