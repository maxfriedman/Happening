...
#import "HappeningCameraVC.h"

@interface HappeningCameraVC () <FastttCameraDelegate>
...
@implementation HappeningCameraVC
...
- (void)viewDidLoad
{
    ...
    self.fastCamera.view.frame = CGRectMake(0, 0, 100, 100);
